  ...
  if (specialRippchen || specialSchnitzel) {
    ...
    return (
      <>
        ...
        <div className="sm:px-2.5 sm:py-1.5 px-1.5 py-1 rounded-full block hover:opacity-90 hover:scale-105 transition-all cursor-pointer" style={{ backgroundColor: '#8fa9b3' }}>
