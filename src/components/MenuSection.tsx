      ...
      <div className="space-y-4 pb-2">
        {items.map((item, i) => {
          ...
          return (
            <div
              key={`${item.id}-${i}`}
              className="bg-white hover:bg-gray-100 rounded-3xl shadow-md hover:shadow-lg transition-all p-4 flex items-center border border-gray-100 hover:border-black"
            >
